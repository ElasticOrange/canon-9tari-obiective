...
@section('content')
    ...
    <script type="text/template" id="texts-kit">
        ...
        <p class="text-container-description">
            Перфектен за начинаещи, Canon EF-S 18-135mm f/3.5-5.6 IS STM е обектив с общо предназначение, който ви предлага по-голямо увеличение от стандартния обектив, доставен с фотоапарата, така че далечните обекти изглеждат близки и можете да заснемате интересни подробности или спиращи дъха пейзажи. Искате дискретно и тихо фокусиране при запис на видео? Няма проблем – обективът използва технология със стъпков мотор (STM).<br />
            Задайте настройка за минимално фокусно разстояние (18mm) на обективът, приближете се физически до заснемания обект и снимката ще пресъздаде вашето пряко участие в сцената.
        </p>
    </script>
